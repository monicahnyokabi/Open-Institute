  ...
  return (
    <NavbarContainer useTransparent={useTransparent}>
      ...
      <AccessibilityContainer>
        {!isMobile && <AnchorLink>Alpha Club</AnchorLink>}
        {!isMobile && <AnchorLink>About</AnchorLink>}
        {!isMobile && <AnchorLink>Cohorts</AnchorLink>}
        {!isMobile && <AnchorLink>Registration</AnchorLink>}
        {!isMobile && <AnchorLink>Gallery</AnchorLink>}
