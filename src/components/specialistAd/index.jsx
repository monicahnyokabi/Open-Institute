    ...
    <SpecialistAdContainer>
      <ContentContainer>
        <SloganContainer>
          ...
          <SloganContainer>
            <Slogan>You’re a motivated Alumni, and you </Slogan>
            <Slogan>want to join an environment and software oriented club? </Slogan>
            <Slogan>Join alpha group</Slogan>
          </SloganContainer>
          <Marginer direction="vertical" margin="0.8em" />
          <Button size={15}>Join as Alumni</Button>
        </SloganContainer>
        <StandoutImage>
